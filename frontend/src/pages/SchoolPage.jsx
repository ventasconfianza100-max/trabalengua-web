...
const PRODUCT_TEMPLATES = [
  {
    ...
    name: "Buzo Completo",
    base_price: 32000,
    image_url: "/images/productos/buzo-completo.jpg",
  },
  {
    type_key: "pantalon_buzo",
    name: "Pantalón de Buzo",
    base_price: 18000,
    image_url: "/images/productos/pantalon-buzo.jpg",
  },
  {
    type_key: "polera_buzo",
    name: "Polerón de buzo",
    base_price: 19000,
    image_url: "/images/productos/poleron-buzo.jpg",
  },
  {
    type_key: "polera_corta",
    name: "Polera manga corta",
    base_price: 10500,
    image_url: "/images/productos/polera-corta.jpg",
  },
  {
    type_key: "polera_larga",
    name: "Polera manga larga",
    base_price: 12000,
    image_url: "/images/productos/polera-larga.jpg",
  },
  {
    type_key: "polar",
    name: "Polar",
    base_price: 21000,
    image_url: "/images/productos/polar.jpg",
  },
  {
    type_key: "delantal_cotona",
    name: "Delantales",
    base_price: 13990,
    image_url: "/images/productos/delantal.jpg",
  },
  {
    type_key: "cotonas",
    name: "Cotonas",
    base_price: 12990,
    image_url: "/images/productos/cotona.jpg",
  },
];
...
const AMANCAY_PRODUCT_TEMPLATES = [
  {
    ...
    base_price: 13990,
    image_url: "/images/productos/cotonas-delantales.jpg",
  },
];
...
const SchoolPage = () => {
  ...
  const [data, setData] = useState(() => getDefaultData(slug));
  ...
  useEffect(() => {
    ...
    const fallbackData = getDefaultData(slug);
  ...
  const filtered = useMemo(() => {
    ...
    if (q) {
      list = list.filter((p) => {
        const hay = `${p.name} ${p.type_key}`.toLowerCase();
  ...
  if (loading) {
    return (
      <div
        className="max-w-7xl mx-auto px-4 py-24 text-gray-500"
                ...
                >
                  ...
                  <div className="mt-4 flex items-baseline justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      ...
                      >
                        <span
                          className={`inline-block w-1.5 h-1.5 shrink-0 rounded-full ${totalStock > 0 ? "bg-emerald-500" : "bg-gray-400"}`}
                          aria-hidden
                        />
                        <span>
                          {totalStock > 0
