...
export const Footer = () => (
  <footer className="bg-gradient-to-br from-[#922828] to-[#5c1818]" data-testid="site-footer">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 grid md:grid-cols-4 gap-5">
      <div>
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[9px] text-white/60 uppercase tracking-widest">Uniformes Escolares</p>
          </div>
        </div>
        <p className="mt-2 text-xs text-white/70 max-w-xs leading-relaxed">Uniformes escolares y bordados personalizados en Talca.</p>
      </div>
      <div>
        <p className="text-[9px] font-semibold uppercase tracking-[0.18em] text-white/50 mb-2">Colegios</p>
        <ul className="space-y-1 text-xs text-white font-light">
          {SCHOOLS.map((s) => (
      ...
      <div>
        <p className="text-[9px] font-semibold uppercase tracking-[0.18em] text-white/50 mb-2">Secciones</p>
        <ul className="space-y-1 text-xs text-white font-light">
      ...
      <div>
        <p className="text-[9px] font-semibold uppercase tracking-[0.18em] text-white/50 mb-2">Contacto</p>
        <ul className="space-y-1 text-xs text-white font-light">
          <li>{ADDRESS}</li>
